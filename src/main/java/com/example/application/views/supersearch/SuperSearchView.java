...
@Route(value = "productsSearch", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@Tag("super-search-view")
@JsModule("./views/supersearch/super-search-view.ts")
public class SuperSearchView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public SuperSearchView() {
